...
namespace SplitKey.DbContext.Migrations
{
    ...
    [Migration("20221024222743_complex pivot")]
    partial class complexpivot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SplitKey.Domain.WorkerCard", b =>
                {
                    b.HasOne("SplitKey.Domain.GraphicCard", "Card")
                        .WithMany("WorkerCards")
                        .HasForeignKey("CardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SplitKey.Domain.Worker", "Worker")
                        .WithMany("WorkerCards")
                        .HasForeignKey("WorkerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
